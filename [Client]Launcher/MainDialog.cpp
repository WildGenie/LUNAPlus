...
const CString FTP_userID		( "patcher" );
const CString FTP_password		( "luna" );
const CString URL_registration	( "http://forum.uprn.comule.com/phpBB3/ucp.php?mode=register" );
const CString URL_homepage		( "http://forum.uprn.comule.com/phpBB3/" );
const CString URL_content		( "http://uprn.comule.com/" );
//const CString ReleaseFile		( "lunaclient.exe" );
//const CString DebugFile		( "LUNAClient-GMTool.exe" );
const CString LogFile			( "LunaLauncher.log" );
const CString FTP_directory		( "current" );
const TCHAR* FTP_address[] =	{"24.119.245.227:21/",};
