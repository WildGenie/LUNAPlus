		...
		if( fp )
		{
			...
			while( fgets( buffer, sizeof( buffer ), fp ) )
			{
				...
				else if( ! strcmpi( "resolution",  token ) )
				{
					...
					case 0:																	// 0과 같으면,
						{
							m_GameDesc.dispInfo.dwWidth = 800;								// 게임 디스플레이 정보의 가로를 800으로 세팅한다.
							m_GameDesc.dispInfo.dwHeight = 600;								// 게임 디스플레이 정보의 세로를 600으로 세팅한다.
							break;
						}
					case 1:																	// 1과 같으면,
						{
							m_GameDesc.dispInfo.dwWidth = 1024;								// 게임 디스플레이 정보의 가로를 1024으로 세팅한다.
							m_GameDesc.dispInfo.dwHeight = 768;								// 게임 디스플레이 정보의 세로를 768으로 세팅한다.
							break;
						}
					case 2:																	// 2와 같으면,
						{
							m_GameDesc.dispInfo.dwWidth = 1280;								// 게임 디스플레이 정보의 가로를 1280으로 세팅한다.
							m_GameDesc.dispInfo.dwHeight = 1024;								// 게임 디스플레이 정보의 세로를 1024으로 세팅한다.
							break;
						}
					case 3:
						{
					...
					case 4:
						{
							m_GameDesc.dispInfo.dwWidth = 1360;
							m_GameDesc.dispInfo.dwHeight = 768;
							break;
						}
					case 5:
						{
							m_GameDesc.dispInfo.dwWidth = 1366;
							m_GameDesc.dispInfo.dwHeight = 768;
							break;
						}
					default:
